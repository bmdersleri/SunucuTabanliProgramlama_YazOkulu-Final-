    ...
    b.fn.pagination && (g = "pagination2"), b.fn[g] = function (f) {
        ...
        var j = b(this), k = b.extend({}, b.fn[g].defaults, f), l = {
            initialize: function () {
                ...
                var c, d = this, e = a.currentPage, f = d.getTotalPage(), g = d.getTotalNumber(), h = k.showPrevious, i = k.showNext, j = k.showPageNumbers, l = k.showNavigator, m = k.showGoInput, n = k.showGoButton, o = k.pageLink, p = k.prevText, q = k.nextText, r = k.goButtonText, s = k.classPrefix, t = k.disableClassName, u = k.ulClassName, v = "", w = '<input type="text" class="J-paginationjs-go-pagenumber">', x = '<input type="button" class="J-paginationjs-go-button" value="' + r + '">', y = b.isFunction(k.formatNavigator) ? k.formatNavigator(e, f, g) : k.formatNavigator, z = b.isFunction(k.formatGoInput) ? k.formatGoInput(w, e, f, g) : k.formatGoInput, A = b.isFunction(k.formatGoButton) ? k.formatGoButton(x, e, f, g) : k.formatGoButton, B = b.isFunction(k.autoHidePrevious) ? k.autoHidePrevious() : k.autoHidePrevious, C = b.isFunction(k.autoHideNext) ? k.autoHideNext() : k.autoHideNext, D = b.isFunction(k.header) ? k.header(e, f, g) : k.header,
                ...
                return D && (c = d.replaceVariables(D, {currentPage: e, totalPage: f, totalNumber: g}), v += c), (h || j || i) && (v += '<div class="paginationjs-pages">', v += u ? '<ul class="' + u + '">' : "<ul>", h && (e <= 1 ? B || (v += '<li class="' + s + "-prev " + t + '"><a>' + p + "</a></li>") : v += '<li class="' + s + '-prev J-paginationjs-previous" data-num="' + (e - 1) + '" title="Previous page"><a href="' + o + '">' + p + "</a></li>"), j && (v += d.generatePageNumbersHTML(a)), i && (e >= f ? C || (v += '<li class="' + s + "-next " + t + '"><a>' + q + "</a></li>") : v += '<li class="' + s + '-next J-paginationjs-next" data-num="' + (e + 1) + '" title="Next page"><a href="' + o + '">' + q + "</a></li>"), v += "</ul></div>"), l && y && (c = d.replaceVariables(y, {currentPage: e, totalPage: f, totalNumber: g}), v += '<div class="' + s + '-nav J-paginationjs-nav">' + c + "</div>"), m && z && (c = d.replaceVariables(z, {
                    ...
                    totalNumber: g,
                    input: w
                }), v += '<div class="' + s + '-go-input">' + c + "</div>"), n && A && (c = d.replaceVariables(A, {currentPage: e, totalPage: f, totalNumber: g, button: x}), v += '<div class="' + s + '-go-button">' + c + "</div>"), E && (c = d.replaceVariables(E, {currentPage: e, totalPage: f, totalNumber: g}), v += c), v
                ...
                if (!e.disabled) {
                    ...
                    if ((g = parseInt(g)) && !(g < 1)) {
                        ...
                        if (!(l > 0 && g > m)) {
                            ...
                            var p = b.isFunction(k.ajax) ? k.ajax() : k.ajax, q = {type: "get", cache: !1, data: {}, contentType: "application/x-www-form-urlencoded; charset=UTF-8", dataType: "json", async: !0};
        ...
        totalNumber: 0, pageNumber: 1, pageSize: 10, pageRange: 2, showPrevious: !0, showNext: !0, showPageNumbers: !0, showNavigator: !1, showGoInput: !1, showGoButton: !1, pageLink: "", prevText: "&laquo;", nextText: "&raquo;", ellipsisText: "...", goButtonText: "Go", classPrefix: "paginationjs", activeClassName: "active", disableClassName: "disabled", inlineStyle: !0, formatNavigator: "<%= currentPage %> / <%= totalPage %>", formatGoInput: "<%= input %>", formatGoButton: "<%= button %>", position: "bottom", autoHidePrevious: !1, autoHideNext: !1, triggerPagingOnInit: !0, hideWhenLessThanOnePage: !1, showFirstOnEllipsisShow: !0, showLastOnEllipsisShow: !0, callback: function () {
        }
