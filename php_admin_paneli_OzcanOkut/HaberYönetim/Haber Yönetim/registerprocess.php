...
else if ($_POST['password'] !== $_POST['cpassword']) 
{
	...
	include ('register.php');
      ...
      if ($count > 0 ) {
	  echo  "<center><font color='red'>Kullanıcı adı önceden alınmış! farklı bir tane dene</font></center>";
	  include ('register.php');
	  exit();
}
      ...
      if (mysqli_affected_rows($conn) > 0) {
      	echo "<script>alert('BAŞARIYLA KAYIT OLDU');
      	window.location.href='index.php';</script>";
}
else {
	echo "<script>alert('Bir hata oluştu, Tekrar deneyin!');
