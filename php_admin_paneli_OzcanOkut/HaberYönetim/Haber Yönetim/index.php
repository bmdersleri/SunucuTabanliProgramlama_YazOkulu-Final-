...
<p><h2><a href="publicposts.php?post=<?php echo $post_id; ?>"><?php echo $post_title; ?></a></h2></p>
            ...
            <a href="publicposts.php?post=<?php echo $post_id; ?>"><button type="button" class="btn btn-primary">Devamını oku<span class="glyphicon glyphicon-chevron-right"></span></button></a>
            <hr>
            ...
            <hr>
            <ul class="pager">
          <li class="previous"><a href="#"><span class="glyphicon glyphicon-arrow-left"></span> Daha eski</a></li>
          <li class="next"><a href="#">Daha yeni <span class="glyphicon glyphicon-arrow-right"></span></a></li>
        </ul>
          </div>
