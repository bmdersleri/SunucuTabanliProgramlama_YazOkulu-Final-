...
if ( $currentrole == 'user') {
echo "<script> alert('YALNIZCA YÖNETİCİ KULLANICI EKLEYEBİLİR');
...
{
	echo  "<center><font color='red'>Parolalar uyuşmuyor </font></center>";
}
else {
      ...
      if (mysqli_affected_rows($conn) > 0) {
      	echo "<script>alert('YENİ KULLANICI BAŞARIYLA EKLENDİ');
      	window.location.href='index.php';</script>";
}
else {
...
echo "<option value='user'>Kullanıcı</option>";
?>
	...
	<div class="form-group">
		<label for="user_tag">Parola</label>
		<input type="password" name="password" class="form-control" required>
	</div>
	<div class="form-group">
		<label for="user_tag">Parola Onayla</label>
		<input type="password" name="cpassword" class="form-control" required>
	</div>


<button type="submit" name="add" class="btn btn-primary" value="Add User">Kullanıcı Ekle</button>
