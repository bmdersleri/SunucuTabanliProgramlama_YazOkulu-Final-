...
<div class="form-group">
	...
	<div class="form-group">
		...
		<input type="password" name="currentpassword" class="form-control" placeholder="Güncel şifrenizi giriniz" required>
	</div>
	<div class="form-group">
		<label for="usertag">Yeni Parola<font color='brown'> (Parola değiştirmek isteğe bağlıdır)</font></label>
		<input type="password" name="newpassword" class="form-control" placeholder="Yeni Şifreyi Girin">
	</div>
	<div class="form-group">
		<label for="usertag">Yeni parolayı onayla</label>
		<input type="password" name="confirmnewpassword" class="form-control" placeholder="Yeni şifreyi tekrar giriniz" >
	</div>
<hr>
