							...
							<form class="form-valide" method="post">
								<div class="row">
									<div class="col">
										...
										<div class="form-group row">
											<label class="col-lg-3 col-form-label" for="tag">Tags
												<span class="text-danger">*</span>
											</label>
											<div class="col-lg-8">
												<input type="text" class="form-control" id="tag" name="tag" value="<?=$values['tag']?>" placeholder="Add tags to post (Exp 1, exp 2, exp3)">
											</div>
										</div>
										<div class="form-group row">
