...
$kullanicisorgu->execute(array(
  ...
  'kullanici_yetki'=>2 #admin kullanıcı yetkisi 2

));
$varmi=$kullanicisorgu->rowCount(); //kullanici var mı sayac

if ($varmi==0) {
  header("Location:login?durum=izinsizgiris"); #önceden kayıtlı değilse -> login sayfasına izinsiz giriş 
}
...
<head>
  ...
  <title>Komsu Market <?php echo $_SESSION['girisbelgesi']; ?></title>
