            ...
            <div class="content-wrap">
                    ...
                    <div class="col-sm-3">
                        <div class="profit" id="profitClose">
                            <div class="headline ">
                                <h3>
                                    <span>
                                        <i class="maki-ferry"></i> Toplam Ziyaretçi</span>
                                </h3>
                    ...
                    <div class="col-sm-3">
                        <div class="profit" id="profitClose">
                            <div class="headline ">
                                <h3>
                                    <span>
                                        <i class="maki-ferry"></i> Bütün Çalışanlar</span>
                                </h3>
                                <div class="titleClose">
                        ...
                        <div class="profit" id="profitClose">
                            <div class="headline ">
                                <h3>
                                    <span>
                                        <i class="maki-ferry"></i> Toplam Departman</span>
                                </h3>
                                <div class="titleClose">
                ...
                <div id="footer">
                    ...
                    <div class="copyright">Sevgiyle Yap
                        <span class="entypo-heart"></span>2014 <a href="http://gamatechno.com">Gülümse</a> Her hakkı saklıdır</div>
