            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="assets/img/hoşgeldiniz.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="assets/img/hoşgeldiniz.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">Zehra Ballı</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                     <a href="projecalismalarim.php">
                        <i class="fa fa-th"></i> <span>Proje Çalışmalarım</span>
				            	</a>
                </li>
                <li>
                     <a href="hakkimda.php">
