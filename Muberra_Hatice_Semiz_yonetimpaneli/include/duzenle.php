            ...
            <div class="row">
              <div class="col-md-12">
			    ...
			    <div class="col-md-12">
					<div class="form-group">
					<label> Başlık </label>
					<input type="text" class="form-control" placeholder="Baslık....." name="baslik" value="<?=stripslashes($veri[0]["baslik"])?>">
					</div>
              ...
              <div class="col-md-12">
					...
					<input type="text" class="form-control" placeholder="Desription....." name="aciklama" value="<?=stripslashes($veri[0]["aciklama"])?>">
					</div>
				...
				<div class="col-md-12">
					<div class="form-group">
					<label> Sıra No </label>
					<input type="number" class="form-control" placeholder="Sırano....." name="sırano" style="width:100px;" value="<?=stripslashes($veri[0]["sırano"])?>">
					</div>
