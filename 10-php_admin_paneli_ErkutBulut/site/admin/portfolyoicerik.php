    ...
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            <div class="card-header">
                <a href="portfolyoicerikEkle.php" class="btn btn-primary">Portfolyo İçerik Ekle</a>
            </div>
            <div class="card-body">
                <div id="dataTable">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td><?= $sonuc["id"] ?></td>
                                    <td><img width="200" src="../assets/img/portfolio/<?= $sonuc["kfoto"] ?>" alt="">
                                    </td>
                                    <td><?= $sonuc["baslik"] ?></td>
                                    <td><?= $sonuc["client"] ?></td>
                                    <td><?= $sonuc["date"] ?></td>
                                    ...
                                    <td class="text-center"><?php if ($_SESSION["yetki"] == "1") { ?>
                                            <a href="portfpolyoicerikGuncelle.php?id=<?= $sonuc["id"] ?>">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <img width="200" src="../assets/img/portfolio/<?= $sonuc["kfoto"] ?>" alt="">
