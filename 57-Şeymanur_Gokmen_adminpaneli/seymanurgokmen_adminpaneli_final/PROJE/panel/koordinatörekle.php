...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<div class="form-group input-group">
        ...
        <input name="adsoyad" class="form-control" placeholder="Ad Soyad" type="text">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
    ...
    <div class="form-group input-group">
    	...
    	<input name="telefon" class="form-control" placeholder="Telefon Numarası" type="text">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-user"></i> </span>
		...
		<select class="form-control" name="unvan">
			...
			<option value="Genel Koordinatör">Genel Koordinatör</option>
			<option value="Sosyal Aktiviteler Sorumlusu">Sosyal Aktiviteler Sorumlusu</option>
			<option value="İç İlişkiler Sorumlusu">İç İlişkiler Sorumlusu</option>
			<option value="Dış İlişkiler Sorumlusu">Dış İlişkiler Sorumlusu</option>
			<option value="Teknoloji ve Grafik Sorumlusu">Teknoloji ve Grafik Sorumlusu</option>
		</select>
	</div> <!-- form-group end.// -->
                                         
      <div class="form-group">
        <button type="submit" name="kaydet" class="btn btn-primary btn-block">KAYDET</button>
    </div> <!-- form-group// --> 
     <?php 
		 ...
		 if(isset($_POST["kaydet"]))
	    {
			if (filter_var($email, FILTER_VALIDATE_EMAIL))
			{
              echo '<p style="color:red"> GEÇERSİZ E-MAİL ADRESİ ! </p>';
			   ...
			   $sorgu = "insert into koordinatorler(adsoyad,email,telefon,unvan) values ('".$adsoyad."','".$email."','".$telefon."','".$unvan."')";
