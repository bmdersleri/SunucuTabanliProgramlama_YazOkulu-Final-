...
<div class="content-wrapper" style="background-color:mediumpurple">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
       <a href="<?=SITE?>ekle/<?=$kontrol[0]["tablo"]?>" class="btn btn-primary" style="float: right; margin-bottom:10px;" > YENİ EKLE</a>
        </div>
       </div>
      <div class="card">
            <!-- /.card-header -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  if($veriler!=false)
                  {
                   ...
                   {
                     $sira++;
                     if($veriler[0]["durum"]==1){$aktifpasif='checked="checked"';} else{$aktifpasif='';}
                     ?>
                      <tr>
                      <td><?=$sira?></td>
                      <td>
                     ...
                     <td>
                     <div class="custom-control custom-switch custom-switch-off-indigo custom-switch-on-success">
                    ...
                    <td>
                      ...
                      <a href="<?=SITE?>sil/<?=$kontrol[0]["tablo"]?>/<?=$veriler[$i]["ID"]?>" class="btn-dark btn-sm">Sil</a>
                    </td>
                </tr>
                     <?php
                   }
