                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Kullanıcı Adı</h3></div>
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="login.php">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" name="txtkadi" value="<?=@$kadi ?>" type="text" placeholder="name@example.com" />
                                                <label for="inputEmail">Kullanici Adi</label>
                                            </div>
                                            <div class="form-floating mb-3">
