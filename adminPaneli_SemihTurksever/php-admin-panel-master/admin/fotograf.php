...
$sorgu = $baglanti->prepare('select * FROM `fotograf` WHERE `id` IN (' . $silinecekler . ')');
...
while ($sonuc = $sorgu->fetch()) {
    ...
    $sorgu = $baglanti->prepare('DELETE FROM `fotograf` WHERE `id` IN (' . $silinecekler . ')');
    $sorgu->execute();

}


$sorgu = $baglanti->prepare("SELECT * FROM fotograf order by sira");
$sorgu->execute();
...
<div id="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Fotograflar</li>
        </ol>
        <form action="" method="post">
            <a class="btn btn-primary" href="fotografEkle.php">Yeni Ürün Ekle</a>
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php while ($sonuc = $sorgu->fetch()) { ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn" href="fotografGuncelle.php?id=<?= $sonuc["id"] ?>"><span
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a class="btn btn-danger pull-right mx-4"
                                                           href="Sil.php?sayfa=fotograf&id=<?= $sonuc["id"] ?>">Sil</a>
