...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #1986DA">
    ...
    <a href="<?=SITE?>" class="brand-link">
      <img src="<?=SITE?>dist/img/logo-computer.jpg" border-radius="5px"  class="brand-image img-circle elevation-1"
           style="opacity: .9">
      <span class="brand-text font-weight-cyan">My Computer Shop</span>
    </a>
    ...
    <div class="sidebar" style="background-color: #1986DA">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?=SITE?>dist/img/rahmi.png" class="img-circle elevation-1" alt="User Image">
        </div>
        <div class="info">
                    <p style="color: white">Rahmi KÖSE</p>
        </div>
      </div>
