  ...
  <div class="content container mx-auto flex-grow mb-2" style="width: 900px;">
    <div class="posts px-5">
      ...
      <div>
        ...
        <form action="edit.php" method="POST" enctype="multipart/form-data" class="flex flex-col space-y-6 mt-10">
          <div class="px-5 w-full mx-auto">
            <input type="hidden" name="id" value="<?php echo $id; ?>">
            <!-- error -->
            <?php include(ROOT_PATH . "/app/helpers/formErrors.php") ?>
            <label class="block font-semibold mt-5">Gönderi Başlığı Düzenle</label>
          ...
          <div class="px-5 w-full mx-auto">
            <label class="block font-semibold">Gönderi Düzenle</label>
          ...
          <div class="flex w-full  px-5">
            <label class="w-64 flex flex-col items-center px-3 py-6  rounded-lg shadow-lg tracking-wide border-2 bg-gray-300 bg-opacity-10 cursor-pointer hover:bg-gray-300">
              ...
              <span class="mt-2 text-base leading-normal" id="message">Resim Düzenle</span>
              <input type='file' name="image" id="file" class="hidden" onChange="IsInputFileEmpty()" />
            </label>
          </div>
          <div class="px-5 ">
            <input type="submit" name="update-posts-btn" value="Gönderi Düzenle" class="float-right border-2 bg-gray-300 bg-opacity-10 rounded-lg m-auto py-2 px-4 font-semibold shadow-md mb-5 hover:bg-gray-300 font-bold">
          </div>
        </form>
      </div>
