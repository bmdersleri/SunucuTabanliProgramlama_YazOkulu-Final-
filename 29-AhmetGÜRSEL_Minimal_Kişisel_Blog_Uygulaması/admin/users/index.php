    ...
    <div class="posts px-5">
      ...
      <table class="border-none rounded-2xl mt-12 mx-auto w-full">
        <tr>
          ...
          <th class="border-b-2 text-left px-8 py-4">Kullanıcı Adı</th>
          <th class="border-b-2 text-left px-8 py-4">Kullanici Email</th>
        ...
        <?php foreach ($admin_users as $key => $user) : ?>
          <tr>
            ...
            <td class="border-b-2 px-8 py-4">
              <?php echo $user['kullaniciAdi']; ?></td>
            <td class="border-b-2 px-8 py-4">
              <?php echo $user['kullaniciEmail']; ?></td>
            <td class="border-b-2 text-center px-8 py-4"><a href="edit.php?id=<?php echo $user['id']; ?>"><span class="ml-2" style="font-size: 1.2rem;"><i class="fas fa-edit"></i></span></a></td>
            <td class="border-b-2 text-center px-8 py-4"><a href="index.php?del_id=<?php echo $user['id']; ?>"><span class="ml-2" style="font-size: 1.2rem;"><i class="fas fa-trash-alt"></i></span></a></td>
          </tr>
        <?php endforeach; ?>
