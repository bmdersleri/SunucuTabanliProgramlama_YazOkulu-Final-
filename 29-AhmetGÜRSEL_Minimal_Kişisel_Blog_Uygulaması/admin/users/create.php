    ...
    <div class="posts px-5">
      ...
      <div>
        ...
        <form action="create.php" method="post" class="flex flex-col space-y-6 mt-10">
          ...
          <div class="px-5 ">
            <input type="submit" name="create-users-btn" value="Kullanıcı Ekle" class="float-right border-2 bg-gray-300 bg-opacity-10 rounded-lg m-auto py-2 px-4 font-semibold shadow-md hover:bg-gray-300 font-bold">
          </div>
        </form>
      </div>
